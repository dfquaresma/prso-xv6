...
main(int argc, char *argv[])
{
  ...
  17:	ff 76 04             	pushl  0x4(%esi)
  1a:	e8 41 02 00 00       	call   260 <atoi>
  1f:	83 c4 0c             	add    $0xc,%esp
  22:	89 c3                	mov    %eax,%ebx
  24:	50                   	push   %eax
  25:	68 98 07 00 00       	push   $0x798
  2a:	6a 01                	push   $0x1
  2c:	e8 0f 04 00 00       	call   440 <printf>
  int prio = atoi(argv[2]); printf(1, "prio: %d\n", prio);
  31:	58                   	pop    %eax
  32:	ff 76 08             	pushl  0x8(%esi)
  35:	e8 26 02 00 00       	call   260 <atoi>
  3a:	83 c4 0c             	add    $0xc,%esp
  3d:	89 c6                	mov    %eax,%esi
  3f:	50                   	push   %eax
  40:	68 a2 07 00 00       	push   $0x7a2
  45:	6a 01                	push   $0x1
  47:	e8 f4 03 00 00       	call   440 <printf>

  int oldprio = getpriority(pid);
  4c:	89 1c 24             	mov    %ebx,(%esp)
  4f:	e8 1e 03 00 00       	call   372 <getpriority>
  ...
  setpriority(pid, prio);
  5a:	e8 1b 03 00 00       	call   37a <setpriority>

  printf(1, "%d\n", oldprio);  
  5f:	83 c4 0c             	add    $0xc,%esp
  62:	57                   	push   %edi
  63:	68 9e 07 00 00       	push   $0x79e
  68:	6a 01                	push   $0x1
  6a:	e8 d1 03 00 00       	call   440 <printf>
  return exit();
  6f:	e8 5e 02 00 00       	call   2d2 <exit>
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax

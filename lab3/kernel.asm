...
80103311:	e8 fa 10 00 00       	call   80104410 <initlock>
  (*f0)->type = FD_PIPE;
...
8010336f:	e8 dc 11 00 00       	call   80104550 <acquire>
  if(writable){
...
801033b3:	5d                   	pop    %ebp
    release(&p->lock);
801033b4:	e9 57 12 00 00       	jmp    80104610 <release>
...
801033e4:	e8 27 12 00 00       	call   80104610 <release>
    kfree((char*)p);
...
8010340d:	e8 3e 11 00 00       	call   80104550 <acquire>
  for(i = 0; i < n; i++){
...
801034a4:	e8 67 11 00 00       	call   80104610 <release>
        return -1;
...
801034fb:	e8 10 11 00 00       	call   80104610 <release>
  return n;
...
80103520:	e8 2b 10 00 00       	call   80104550 <acquire>
...
8010358e:	e8 7d 10 00 00       	call   80104610 <release>
      return -1;
...
801035ef:	e8 1c 10 00 00       	call   80104610 <release>
  return i;
...
80103621:	e8 2a 0f 00 00       	call   80104550 <acquire>
...
8010365f:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103665:	e8 a6 0f 00 00       	call   80104610 <release>
...
80103699:	e8 c2 0f 00 00       	call   80104660 <memset>
...
801036c2:	e8 49 0f 00 00       	call   80104610 <release>
}
...
801036eb:	e8 20 0f 00 00       	call   80104610 <release>
...
80103740:	e8 cb 0c 00 00       	call   80104410 <initlock>
}
...
801037bd:	68 2c 78 10 80       	push   $0x8010782c
...
801037f4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037f7:	e8 84 0c 00 00       	call   80104480 <pushcli>
  c = mycpu();
...
80103833:	e8 08 37 00 00       	call   80106f40 <setupkvm>
...
80103851:	e8 ca 33 00 00       	call   80106c20 <inituvm>
...
80103866:	e8 f5 0d 00 00       	call   80104660 <memset>
...
801038c5:	e8 76 0f 00 00       	call   80104840 <safestrcpy>
  p->cwd = namei("/");
...
80103915:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103918:	e8 63 0b 00 00       	call   80104480 <pushcli>
  c = mycpu();
8010391d:	e8 2e fe ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103922:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103928:	e8 93 0b 00 00       	call   801044c0 <popcli>
  if(n > 0){
...
8010393c:	e8 cf 31 00 00       	call   80106b10 <switchuvm>
  return 0;
...
8010395a:	e8 01 34 00 00       	call   80106d60 <allocuvm>
...
8010397a:	e8 11 35 00 00       	call   80106e90 <deallocuvm>
...
80103996:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103999:	e8 e2 0a 00 00       	call   80104480 <pushcli>
  c = mycpu();
8010399e:	e8 ad fd ff ff       	call   80103750 <mycpu>
  p = c->proc;
801039a3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039a9:	e8 12 0b 00 00       	call   801044c0 <popcli>
  if((np = allocproc()) == 0){
...
80103b00:	e8 0b 30 00 00       	call   80106b10 <switchuvm>
...
80103b0b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      p->usage = p->usage + 1;
80103b12:	83 83 80 00 00 00 01 	addl   $0x1,0x80(%ebx)
      swtch(&(c->scheduler), p->context);
80103b19:	e8 7d 0d 00 00       	call   8010489b <swtch>
      switchkvm();
80103b1e:	e8 cd 2f 00 00       	call   80106af0 <switchkvm>
      c->proc = 0;
80103b23:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103b2a:	00 00 00 
80103b2d:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b30:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103b36:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103b3c:	72 b2                	jb     80103af0 <scheduler+0x40>
    release(&ptable.lock);
80103b3e:	83 ec 0c             	sub    $0xc,%esp
80103b41:	68 20 2d 11 80       	push   $0x80112d20
80103b46:	e8 c5 0a 00 00       	call   80104610 <release>
    sti();
80103b4b:	83 c4 10             	add    $0x10,%esp
80103b4e:	eb 80                	jmp    80103ad0 <scheduler+0x20>
...
80103bb3:	e8 e3 0c 00 00       	call   8010489b <swtch>
  mycpu()->intena = intena;
...
80103c16:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c19:	e8 62 08 00 00       	call   80104480 <pushcli>
  c = mycpu();
80103c1e:	e8 2d fb ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103c23:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c29:	e8 92 08 00 00       	call   801044c0 <popcli>
  if(curproc == initproc)
...
80103c82:	e8 c9 08 00 00       	call   80104550 <acquire>
...
80103d4c:	e8 ff 07 00 00       	call   80104550 <acquire>
  pushcli();
80103d51:	e8 2a 07 00 00       	call   80104480 <pushcli>
  c = mycpu();
80103d56:	e8 f5 f9 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103d5b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d61:	e8 5a 07 00 00       	call   801044c0 <popcli>
...
80103d79:	e8 92 08 00 00       	call   80104610 <release>
}
...
80103d9c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d9f:	e8 dc 06 00 00       	call   80104480 <pushcli>
  c = mycpu();
80103da4:	e8 a7 f9 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103da9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103daf:	e8 0c 07 00 00       	call   801044c0 <popcli>
  if(p == 0)
...
80103dd0:	e8 7b 07 00 00       	call   80104550 <acquire>
    release(lk);
80103dd5:	89 34 24             	mov    %esi,(%esp)
80103dd8:	e8 33 08 00 00       	call   80104610 <release>
  p->chan = chan;
...
80103dfa:	e8 11 08 00 00       	call   80104610 <release>
    acquire(lk);
...
80103e0b:	5d                   	pop    %ebp
    acquire(lk);
80103e0c:	e9 3f 07 00 00       	jmp    80104550 <acquire>
...
80103eea:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ef1:	e8 ca 2f 00 00       	call   80106ec0 <freevm>
        release(&ptable.lock);
...
80103f16:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f1d:	e8 ee 06 00 00       	call   80104610 <release>
        return pid;
...
80103f3b:	e8 d0 06 00 00       	call   80104610 <release>
      return -1;
...
80103f5f:	e8 ec 05 00 00       	call   80104550 <acquire>
...
80103fa4:	c9                   	leave  
  release(&ptable.lock);
80103fa5:	e9 66 06 00 00       	jmp    80104610 <release>
...
80103fbf:	e8 8c 05 00 00       	call   80104550 <acquire>
...
80103ffd:	e8 0e 06 00 00       	call   80104610 <release>
      return 0;
...
80104018:	e8 f3 05 00 00       	call   80104610 <release>
  return -1;
...
8010404b:	68 87 7b 10 80       	push   $0x80107b87
...
80104071:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104074:	ba e0 77 10 80       	mov    $0x801077e0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104079:	77 11                	ja     8010408c <procdump+0x5c>
8010407b:	8b 14 85 54 78 10 80 	mov    -0x7fef87ac(,%eax,4),%edx
      state = "???";
80104082:	b8 e0 77 10 80       	mov    $0x801077e0,%eax
...
80104094:	68 e4 77 10 80       	push   $0x801077e4
...
801040bb:	e8 70 03 00 00       	call   80104430 <getcallerpcs>
...
801040d9:	68 21 72 10 80       	push   $0x80107221
...
80104105:	8b 75 08             	mov    0x8(%ebp),%esi
  struct proc *p;

  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104108:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
8010410d:	83 ec 0c             	sub    $0xc,%esp
80104110:	68 20 2d 11 80       	push   $0x80112d20
80104115:	e8 36 04 00 00       	call   80104550 <acquire>
8010411a:	83 c4 10             	add    $0x10,%esp
8010411d:	eb 0f                	jmp    8010412e <getpriority+0x2e>
8010411f:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104120:	81 c3 84 00 00 00    	add    $0x84,%ebx
80104126:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
8010412c:	73 22                	jae    80104150 <getpriority+0x50>
    if(p->pid == pid){
8010412e:	39 73 10             	cmp    %esi,0x10(%ebx)
80104131:	75 ed                	jne    80104120 <getpriority+0x20>
      release(&ptable.lock);
80104133:	83 ec 0c             	sub    $0xc,%esp
80104136:	68 20 2d 11 80       	push   $0x80112d20
8010413b:	e8 d0 04 00 00       	call   80104610 <release>
      return p->prio;
80104140:	8b 43 7c             	mov    0x7c(%ebx),%eax
...
80104153:	68 20 2d 11 80       	push   $0x80112d20
80104158:	e8 b3 04 00 00       	call   80104610 <release>
  return -1;
...
8010418c:	eb 0e                	jmp    8010419c <setpriority+0x2c>
8010418e:	66 90                	xchg   %ax,%ax
80104190:	05 84 00 00 00       	add    $0x84,%eax
80104195:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
8010419a:	73 24                	jae    801041c0 <setpriority+0x50>
    if(p->pid == pid){
8010419c:	39 58 10             	cmp    %ebx,0x10(%eax)
8010419f:	75 ef                	jne    80104190 <setpriority+0x20>
      p->prio = prio;
801041a1:	8b 55 0c             	mov    0xc(%ebp),%edx
      release(&ptable.lock);
801041a4:	83 ec 0c             	sub    $0xc,%esp
      p->prio = prio;
801041a7:	89 50 7c             	mov    %edx,0x7c(%eax)
      release(&ptable.lock);
801041aa:	68 20 2d 11 80       	push   $0x80112d20
801041af:	e8 5c 04 00 00       	call   80104610 <release>
      return 0;
801041b4:	83 c4 10             	add    $0x10,%esp
801041b7:	31 c0                	xor    %eax,%eax
    }
  }
  release(&ptable.lock);
  return -1;
...
801041c8:	e8 43 04 00 00       	call   80104610 <release>
  return -1;
...
801041e5:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041e8:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
801041ed:	83 ec 0c             	sub    $0xc,%esp
801041f0:	68 20 2d 11 80       	push   $0x80112d20
801041f5:	e8 56 03 00 00       	call   80104550 <acquire>
801041fa:	83 c4 10             	add    $0x10,%esp
801041fd:	eb 0f                	jmp    8010420e <getusage+0x2e>
801041ff:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104200:	81 c3 84 00 00 00    	add    $0x84,%ebx
80104206:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
8010420c:	73 22                	jae    80104230 <getusage+0x50>
    if(p->pid == pid){
8010420e:	39 73 10             	cmp    %esi,0x10(%ebx)
80104211:	75 ed                	jne    80104200 <getusage+0x20>
      release(&ptable.lock);
80104213:	83 ec 0c             	sub    $0xc,%esp
80104216:	68 20 2d 11 80       	push   $0x80112d20
8010421b:	e8 f0 03 00 00       	call   80104610 <release>
      return p->usage;
80104220:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
...
80104238:	e8 d3 03 00 00       	call   80104610 <release>
  return -1;
8010423d:	83 c4 10             	add    $0x10,%esp
}
80104240:	8d 65 f8             	lea    -0x8(%ebp),%esp
  return -1;
...
8010425c:	e8 ef 02 00 00       	call   80104550 <acquire>
80104261:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){    
80104264:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104269:	eb 11                	jmp    8010427c <serialkiller+0x2c>
8010426b:	90                   	nop
8010426c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104270:	05 84 00 00 00       	add    $0x84,%eax
80104275:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
8010427a:	73 44                	jae    801042c0 <serialkiller+0x70>
    if (p->killed != 1 && p->pid > 2) {
8010427c:	83 78 24 01          	cmpl   $0x1,0x24(%eax)
80104280:	74 ee                	je     80104270 <serialkiller+0x20>
80104282:	8b 58 10             	mov    0x10(%eax),%ebx
80104285:	83 fb 02             	cmp    $0x2,%ebx
80104288:	7e e6                	jle    80104270 <serialkiller+0x20>
      processid = p->pid;
      release(&ptable.lock);
8010428a:	83 ec 0c             	sub    $0xc,%esp
8010428d:	68 20 2d 11 80       	push   $0x80112d20
80104292:	e8 79 03 00 00       	call   80104610 <release>
      kill(processid);
80104297:	89 1c 24             	mov    %ebx,(%esp)
8010429a:	e8 11 fd ff ff       	call   80103fb0 <kill>
...
801042a6:	68 ed 77 10 80       	push   $0x801077ed
801042ab:	e8 b0 c3 ff ff       	call   80100660 <cprintf>
  return processid;
}
801042b0:	89 d8                	mov    %ebx,%eax
...
801042c0:	83 ec 0c             	sub    $0xc,%esp
  int processid = -1;
801042c3:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  if (!killed) release(&ptable.lock); 
801042c8:	68 20 2d 11 80       	push   $0x80112d20
801042cd:	e8 3e 03 00 00       	call   80104610 <release>
801042d2:	83 c4 10             	add    $0x10,%esp
801042d5:	eb cb                	jmp    801042a2 <serialkiller+0x52>
...
801042ea:	68 6c 78 10 80       	push   $0x8010786c
...
80104345:	e8 46 fa ff ff       	call   80103d90 <sleep>
  while (lk->locked) {
...
80104353:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104359:	e8 92 f4 ff ff       	call   801037f0 <myproc>
...
801043a4:	e8 a7 fb ff ff       	call   80103f50 <wakeup>
  release(&lk->lk);
...
801043e3:	e8 08 f4 ff ff       	call   801037f0 <myproc>
...
80104489:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010448a:	e8 c1 f2 ff ff       	call   80103750 <mycpu>
...
8010449f:	e8 ac f2 ff ff       	call   80103750 <mycpu>
...
80104505:	68 77 78 10 80       	push   $0x80107877
8010450a:	e8 81 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010450f:	83 ec 0c             	sub    $0xc,%esp
80104512:	68 8e 78 10 80       	push   $0x8010788e
...
80104538:	e8 13 f2 ff ff       	call   80103750 <mycpu>
...
80104594:	e8 b7 f1 ff ff       	call   80103750 <mycpu>
...
801045f7:	68 95 78 10 80       	push   $0x80107895
...
8010464c:	68 9d 78 10 80       	push   $0x8010789d
...
801048b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801048ba:	e8 31 ef ff ff       	call   801037f0 <myproc>
...
80104965:	e8 86 ee ff ff       	call   801037f0 <myproc>
...
80104973:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104976:	e8 75 ee ff ff       	call   801037f0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801049b8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801049bb:	e8 30 ee ff ff       	call   801037f0 <myproc>
...
80104a54:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a57:	e8 94 ed ff ff       	call   801037f0 <myproc>
...
80104a6c:	8b 14 85 e0 78 10 80 	mov    -0x7fef8720(,%eax,4),%edx
...
80104a90:	68 a5 78 10 80       	push   $0x801078a5
...
80104be4:	68 64 79 10 80       	push   $0x80107964
...
80104bfc:	68 63 79 10 80       	push   $0x80107963
...
80104c15:	68 57 79 10 80       	push   $0x80107957
...
80104c2a:	68 66 79 10 80       	push   $0x80107966
80104c2f:	e8 5c b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c34:	83 ec 0c             	sub    $0xc,%esp
80104c37:	68 48 79 10 80       	push   $0x80107948
...
80104c74:	e8 77 eb ff ff       	call   801037f0 <myproc>
...
80104cb9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104cbb:	e8 30 eb ff ff       	call   801037f0 <myproc>
...
80104e03:	78 2b                	js     80104e30 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e05:	e8 e6 e9 ff ff       	call   801037f0 <myproc>
...
80105029:	58                   	pop    %eax
8010502a:	5a                   	pop    %edx
8010502b:	68 64 79 10 80       	push   $0x80107964
...
80105044:	68 63 79 10 80       	push   $0x80107963
...
8010523f:	0f 84 a6 00 00 00    	je     801052eb <sys_open+0x12b>
  struct proc *curproc = myproc();
80105245:	e8 a6 e5 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105415:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105418:	e8 d3 e3 ff ff       	call   801037f0 <myproc>
...
801055dc:	e8 6f dc ff ff       	call   80103250 <pipealloc>
...
801055ef:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801055f1:	e8 fa e1 ff ff       	call   801037f0 <myproc>
...
80105617:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010561a:	e8 d1 e1 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105651:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105658:	e8 93 e1 ff ff       	call   801037f0 <myproc>
...
80105693:	5d                   	pop    %ebp
  return fork();
80105694:	e9 f7 e2 ff ff       	jmp    80103990 <fork>
...
801056a3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056a6:	e8 65 e5 ff ff       	call   80103c10 <exit>
...
801056b3:	5d                   	pop    %ebp
  return wait();
801056b4:	e9 97 e7 ff ff       	jmp    80103e50 <wait>
...
801056de:	e8 cd e8 ff ff       	call   80103fb0 <kill>
...
80105703:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105706:	e8 e5 e0 ff ff       	call   801037f0 <myproc>
...
80105727:	78 27                	js     80105750 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105729:	e8 c2 e0 ff ff       	call   801037f0 <myproc>
  if(growproc(n) < 0)
...
80105736:	e8 d5 e1 ff ff       	call   80103910 <growproc>
...
8010578d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105790:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
...
801057a8:	68 a0 56 11 80       	push   $0x801156a0
801057ad:	e8 de e5 ff ff       	call   80103d90 <sleep>
  while(ticks - ticks0 < n){
801057b2:	a1 a0 56 11 80       	mov    0x801156a0,%eax
...
80105814:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105817:	68 60 4e 11 80       	push   $0x80114e60
8010581c:	e8 2f ed ff ff       	call   80104550 <acquire>
  xticks = ticks;
80105821:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
...
80105856:	78 18                	js     80105870 <sys_getpriority+0x30>
    return -1;
  return getpriority(pid);
80105858:	83 ec 0c             	sub    $0xc,%esp
8010585b:	ff 75 f4             	pushl  -0xc(%ebp)
8010585e:	e8 9d e8 ff ff       	call   80104100 <getpriority>
...
80105896:	78 38                	js     801058d0 <sys_setpriority+0x50>
80105898:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010589b:	83 ec 08             	sub    $0x8,%esp
8010589e:	50                   	push   %eax
8010589f:	6a 01                	push   $0x1
801058a1:	e8 ba f0 ff ff       	call   80104960 <argint>
801058a6:	83 c4 10             	add    $0x10,%esp
801058a9:	85 c0                	test   %eax,%eax
801058ab:	78 23                	js     801058d0 <sys_setpriority+0x50>
801058ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058b0:	83 f8 1f             	cmp    $0x1f,%eax
801058b3:	7f 1b                	jg     801058d0 <sys_setpriority+0x50>
    return -1;
  return setpriority(pid, prio);
801058b5:	83 ec 08             	sub    $0x8,%esp
801058b8:	50                   	push   %eax
801058b9:	ff 75 f0             	pushl  -0x10(%ebp)
801058bc:	e8 af e8 ff ff       	call   80104170 <setpriority>
...
801058ec:	e8 6f f0 ff ff       	call   80104960 <argint>
801058f1:	83 c4 10             	add    $0x10,%esp
801058f4:	85 c0                	test   %eax,%eax
801058f6:	78 18                	js     80105910 <sys_getusage+0x30>
    return -1;
  return getusage(pid);
801058f8:	83 ec 0c             	sub    $0xc,%esp
801058fb:	ff 75 f4             	pushl  -0xc(%ebp)
801058fe:	e8 dd e8 ff ff       	call   801041e0 <getusage>
...
80105923:	5d                   	pop    %ebp
  return serialkiller();
80105924:	e9 27 e9 ff ff       	jmp    80104250 <serialkiller>
...
801059b4:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
801059ba:	e8 51 ea ff ff       	call   80104410 <initlock>
}
...
80105a3a:	0f 84 40 02 00 00    	je     80105c80 <trap+0x280>
80105a40:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105a44:	0f 84 36 02 00 00    	je     80105c80 <trap+0x280>
...
80105a85:	68 0c 7a 10 80       	push   $0x80107a0c
...
80105b1d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105b20:	e8 2b ef ff ff       	call   80104a50 <syscall>
    if(myproc()->killed)
...
80105bc7:	68 b4 79 10 80       	push   $0x801079b4
...
80105c0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105c10:	e8 fb df ff ff       	call   80103c10 <exit>
80105c15:	e9 aa fe ff ff       	jmp    80105ac4 <trap+0xc4>
80105c1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105c20:	83 ec 0c             	sub    $0xc,%esp
80105c23:	68 60 4e 11 80       	push   $0x80114e60
80105c28:	e8 23 e9 ff ff       	call   80104550 <acquire>
      ticks++;
80105c2d:	a1 a0 56 11 80       	mov    0x801156a0,%eax
      if (ticks != 0 && ticks % 500 == 0)
80105c32:	83 c4 10             	add    $0x10,%esp
      ticks++;
80105c35:	8d 48 01             	lea    0x1(%eax),%ecx
      if (ticks != 0 && ticks % 500 == 0)
80105c38:	85 c9                	test   %ecx,%ecx
      ticks++;
80105c3a:	89 0d a0 56 11 80    	mov    %ecx,0x801156a0
      if (ticks != 0 && ticks % 500 == 0)
80105c40:	74 16                	je     80105c58 <trap+0x258>
80105c42:	ba d3 4d 62 10       	mov    $0x10624dd3,%edx
80105c47:	89 c8                	mov    %ecx,%eax
80105c49:	f7 e2                	mul    %edx
80105c4b:	c1 ea 05             	shr    $0x5,%edx
80105c4e:	69 d2 f4 01 00 00    	imul   $0x1f4,%edx,%edx
80105c54:	39 d1                	cmp    %edx,%ecx
80105c56:	74 21                	je     80105c79 <trap+0x279>
      wakeup(&ticks);
80105c58:	83 ec 0c             	sub    $0xc,%esp
80105c5b:	68 a0 56 11 80       	push   $0x801156a0
80105c60:	e8 eb e2 ff ff       	call   80103f50 <wakeup>
      release(&tickslock);
80105c65:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105c6c:	e8 9f e9 ff ff       	call   80104610 <release>
80105c71:	83 c4 10             	add    $0x10,%esp
80105c74:	e9 e4 fe ff ff       	jmp    80105b5d <trap+0x15d>
        serialkiller();
80105c79:	e8 d2 e5 ff ff       	call   80104250 <serialkiller>
80105c7e:	eb d8                	jmp    80105c58 <trap+0x258>
80105c80:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c83:	e8 48 db ff ff       	call   801037d0 <cpuid>
80105c88:	83 ec 0c             	sub    $0xc,%esp
80105c8b:	56                   	push   %esi
80105c8c:	53                   	push   %ebx
80105c8d:	50                   	push   %eax
80105c8e:	ff 77 30             	pushl  0x30(%edi)
80105c91:	68 d8 79 10 80       	push   $0x801079d8
80105c96:	e8 c5 a9 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c9b:	83 c4 14             	add    $0x14,%esp
80105c9e:	68 ae 79 10 80       	push   $0x801079ae
80105ca3:	e8 e8 a6 ff ff       	call   80100390 <panic>
...
80105e37:	6a 00                	push   $0x0
  jmp alltraps
80105e39:	e9 eb fa ff ff       	jmp    80105929 <alltraps>
...
80105e40:	6a 01                	push   $0x1
  jmp alltraps
80105e42:	e9 e2 fa ff ff       	jmp    80105929 <alltraps>
...
80105e49:	6a 02                	push   $0x2
  jmp alltraps
80105e4b:	e9 d9 fa ff ff       	jmp    80105929 <alltraps>
...
80105e52:	6a 03                	push   $0x3
  jmp alltraps
80105e54:	e9 d0 fa ff ff       	jmp    80105929 <alltraps>
...
80105e5b:	6a 04                	push   $0x4
  jmp alltraps
80105e5d:	e9 c7 fa ff ff       	jmp    80105929 <alltraps>
...
80105e6d:	6a 06                	push   $0x6
  jmp alltraps
80105e6f:	e9 b5 fa ff ff       	jmp    80105929 <alltraps>
...
80105e76:	6a 07                	push   $0x7
  jmp alltraps
80105e78:	e9 ac fa ff ff       	jmp    80105929 <alltraps>
...
80105e7d:	6a 08                	push   $0x8
  jmp alltraps
80105e7f:	e9 a5 fa ff ff       	jmp    80105929 <alltraps>
...
80105e86:	6a 09                	push   $0x9
  jmp alltraps
80105e88:	e9 9c fa ff ff       	jmp    80105929 <alltraps>
...
80105e8d:	6a 0a                	push   $0xa
  jmp alltraps
80105e8f:	e9 95 fa ff ff       	jmp    80105929 <alltraps>
...
80105e94:	6a 0b                	push   $0xb
  jmp alltraps
80105e96:	e9 8e fa ff ff       	jmp    80105929 <alltraps>
...
80105ea2:	6a 0d                	push   $0xd
  jmp alltraps
80105ea4:	e9 80 fa ff ff       	jmp    80105929 <alltraps>
...
80105ea9:	6a 0e                	push   $0xe
  jmp alltraps
80105eab:	e9 79 fa ff ff       	jmp    80105929 <alltraps>
...
80105eb2:	6a 0f                	push   $0xf
  jmp alltraps
80105eb4:	e9 70 fa ff ff       	jmp    80105929 <alltraps>
...
80105ebb:	6a 10                	push   $0x10
  jmp alltraps
80105ebd:	e9 67 fa ff ff       	jmp    80105929 <alltraps>
...
80105ec2:	6a 11                	push   $0x11
  jmp alltraps
80105ec4:	e9 60 fa ff ff       	jmp    80105929 <alltraps>
...
80105ecb:	6a 12                	push   $0x12
  jmp alltraps
80105ecd:	e9 57 fa ff ff       	jmp    80105929 <alltraps>
...
80105ed4:	6a 13                	push   $0x13
  jmp alltraps
80105ed6:	e9 4e fa ff ff       	jmp    80105929 <alltraps>
...
80105edd:	6a 14                	push   $0x14
  jmp alltraps
80105edf:	e9 45 fa ff ff       	jmp    80105929 <alltraps>
...
80105ee6:	6a 15                	push   $0x15
  jmp alltraps
80105ee8:	e9 3c fa ff ff       	jmp    80105929 <alltraps>
...
80105eef:	6a 16                	push   $0x16
  jmp alltraps
80105ef1:	e9 33 fa ff ff       	jmp    80105929 <alltraps>
...
80105ef8:	6a 17                	push   $0x17
  jmp alltraps
80105efa:	e9 2a fa ff ff       	jmp    80105929 <alltraps>
...
80105f01:	6a 18                	push   $0x18
  jmp alltraps
80105f03:	e9 21 fa ff ff       	jmp    80105929 <alltraps>
...
80105f0a:	6a 19                	push   $0x19
  jmp alltraps
80105f0c:	e9 18 fa ff ff       	jmp    80105929 <alltraps>
...
80105f13:	6a 1a                	push   $0x1a
  jmp alltraps
80105f15:	e9 0f fa ff ff       	jmp    80105929 <alltraps>
...
80105f1c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f1e:	e9 06 fa ff ff       	jmp    80105929 <alltraps>
...
80105f25:	6a 1c                	push   $0x1c
  jmp alltraps
80105f27:	e9 fd f9 ff ff       	jmp    80105929 <alltraps>
...
80105f2e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f30:	e9 f4 f9 ff ff       	jmp    80105929 <alltraps>
...
80105f37:	6a 1e                	push   $0x1e
  jmp alltraps
80105f39:	e9 eb f9 ff ff       	jmp    80105929 <alltraps>
...
80105f40:	6a 1f                	push   $0x1f
  jmp alltraps
80105f42:	e9 e2 f9 ff ff       	jmp    80105929 <alltraps>
...
80105f49:	6a 20                	push   $0x20
  jmp alltraps
80105f4b:	e9 d9 f9 ff ff       	jmp    80105929 <alltraps>
...
80105f52:	6a 21                	push   $0x21
  jmp alltraps
80105f54:	e9 d0 f9 ff ff       	jmp    80105929 <alltraps>
...
80105f5b:	6a 22                	push   $0x22
  jmp alltraps
80105f5d:	e9 c7 f9 ff ff       	jmp    80105929 <alltraps>
...
80105f64:	6a 23                	push   $0x23
  jmp alltraps
80105f66:	e9 be f9 ff ff       	jmp    80105929 <alltraps>
...
80105f6d:	6a 24                	push   $0x24
  jmp alltraps
80105f6f:	e9 b5 f9 ff ff       	jmp    80105929 <alltraps>
...
80105f76:	6a 25                	push   $0x25
  jmp alltraps
80105f78:	e9 ac f9 ff ff       	jmp    80105929 <alltraps>
...
80105f7f:	6a 26                	push   $0x26
  jmp alltraps
80105f81:	e9 a3 f9 ff ff       	jmp    80105929 <alltraps>
...
80105f88:	6a 27                	push   $0x27
  jmp alltraps
80105f8a:	e9 9a f9 ff ff       	jmp    80105929 <alltraps>
...
80105f91:	6a 28                	push   $0x28
  jmp alltraps
80105f93:	e9 91 f9 ff ff       	jmp    80105929 <alltraps>
...
80105f9a:	6a 29                	push   $0x29
  jmp alltraps
80105f9c:	e9 88 f9 ff ff       	jmp    80105929 <alltraps>
...
80105fa3:	6a 2a                	push   $0x2a
  jmp alltraps
80105fa5:	e9 7f f9 ff ff       	jmp    80105929 <alltraps>
...
80105fac:	6a 2b                	push   $0x2b
  jmp alltraps
80105fae:	e9 76 f9 ff ff       	jmp    80105929 <alltraps>
...
80105fb5:	6a 2c                	push   $0x2c
  jmp alltraps
80105fb7:	e9 6d f9 ff ff       	jmp    80105929 <alltraps>
...
80105fbe:	6a 2d                	push   $0x2d
  jmp alltraps
80105fc0:	e9 64 f9 ff ff       	jmp    80105929 <alltraps>
...
80105fc7:	6a 2e                	push   $0x2e
  jmp alltraps
80105fc9:	e9 5b f9 ff ff       	jmp    80105929 <alltraps>
...
80105fd0:	6a 2f                	push   $0x2f
  jmp alltraps
80105fd2:	e9 52 f9 ff ff       	jmp    80105929 <alltraps>
...
80105fd9:	6a 30                	push   $0x30
  jmp alltraps
80105fdb:	e9 49 f9 ff ff       	jmp    80105929 <alltraps>
...
80105fe2:	6a 31                	push   $0x31
  jmp alltraps
80105fe4:	e9 40 f9 ff ff       	jmp    80105929 <alltraps>
...
80105feb:	6a 32                	push   $0x32
  jmp alltraps
80105fed:	e9 37 f9 ff ff       	jmp    80105929 <alltraps>
...
80105ff4:	6a 33                	push   $0x33
  jmp alltraps
80105ff6:	e9 2e f9 ff ff       	jmp    80105929 <alltraps>
...
80105ffd:	6a 34                	push   $0x34
  jmp alltraps
80105fff:	e9 25 f9 ff ff       	jmp    80105929 <alltraps>
...
80106006:	6a 35                	push   $0x35
  jmp alltraps
80106008:	e9 1c f9 ff ff       	jmp    80105929 <alltraps>
...
8010600f:	6a 36                	push   $0x36
  jmp alltraps
80106011:	e9 13 f9 ff ff       	jmp    80105929 <alltraps>
...
80106018:	6a 37                	push   $0x37
  jmp alltraps
8010601a:	e9 0a f9 ff ff       	jmp    80105929 <alltraps>
...
80106021:	6a 38                	push   $0x38
  jmp alltraps
80106023:	e9 01 f9 ff ff       	jmp    80105929 <alltraps>
...
8010602a:	6a 39                	push   $0x39
  jmp alltraps
8010602c:	e9 f8 f8 ff ff       	jmp    80105929 <alltraps>
...
80106033:	6a 3a                	push   $0x3a
  jmp alltraps
80106035:	e9 ef f8 ff ff       	jmp    80105929 <alltraps>
...
8010603c:	6a 3b                	push   $0x3b
  jmp alltraps
8010603e:	e9 e6 f8 ff ff       	jmp    80105929 <alltraps>
...
80106045:	6a 3c                	push   $0x3c
  jmp alltraps
80106047:	e9 dd f8 ff ff       	jmp    80105929 <alltraps>
...
8010604e:	6a 3d                	push   $0x3d
  jmp alltraps
80106050:	e9 d4 f8 ff ff       	jmp    80105929 <alltraps>
...
80106057:	6a 3e                	push   $0x3e
  jmp alltraps
80106059:	e9 cb f8 ff ff       	jmp    80105929 <alltraps>
...
80106060:	6a 3f                	push   $0x3f
  jmp alltraps
80106062:	e9 c2 f8 ff ff       	jmp    80105929 <alltraps>
...
80106069:	6a 40                	push   $0x40
  jmp alltraps
8010606b:	e9 b9 f8 ff ff       	jmp    80105929 <alltraps>
...
80106072:	6a 41                	push   $0x41
  jmp alltraps
80106074:	e9 b0 f8 ff ff       	jmp    80105929 <alltraps>
...
8010607b:	6a 42                	push   $0x42
  jmp alltraps
8010607d:	e9 a7 f8 ff ff       	jmp    80105929 <alltraps>
...
80106084:	6a 43                	push   $0x43
  jmp alltraps
80106086:	e9 9e f8 ff ff       	jmp    80105929 <alltraps>
...
8010608d:	6a 44                	push   $0x44
  jmp alltraps
8010608f:	e9 95 f8 ff ff       	jmp    80105929 <alltraps>
...
80106096:	6a 45                	push   $0x45
  jmp alltraps
80106098:	e9 8c f8 ff ff       	jmp    80105929 <alltraps>
...
8010609f:	6a 46                	push   $0x46
  jmp alltraps
801060a1:	e9 83 f8 ff ff       	jmp    80105929 <alltraps>
...
801060a8:	6a 47                	push   $0x47
  jmp alltraps
801060aa:	e9 7a f8 ff ff       	jmp    80105929 <alltraps>
...
801060b1:	6a 48                	push   $0x48
  jmp alltraps
801060b3:	e9 71 f8 ff ff       	jmp    80105929 <alltraps>
...
801060ba:	6a 49                	push   $0x49
  jmp alltraps
801060bc:	e9 68 f8 ff ff       	jmp    80105929 <alltraps>
...
801060c3:	6a 4a                	push   $0x4a
  jmp alltraps
801060c5:	e9 5f f8 ff ff       	jmp    80105929 <alltraps>
...
801060cc:	6a 4b                	push   $0x4b
  jmp alltraps
801060ce:	e9 56 f8 ff ff       	jmp    80105929 <alltraps>
...
801060d5:	6a 4c                	push   $0x4c
  jmp alltraps
801060d7:	e9 4d f8 ff ff       	jmp    80105929 <alltraps>
...
801060de:	6a 4d                	push   $0x4d
  jmp alltraps
801060e0:	e9 44 f8 ff ff       	jmp    80105929 <alltraps>
...
801060e7:	6a 4e                	push   $0x4e
  jmp alltraps
801060e9:	e9 3b f8 ff ff       	jmp    80105929 <alltraps>
...
801060f0:	6a 4f                	push   $0x4f
  jmp alltraps
801060f2:	e9 32 f8 ff ff       	jmp    80105929 <alltraps>
...
801060f9:	6a 50                	push   $0x50
  jmp alltraps
801060fb:	e9 29 f8 ff ff       	jmp    80105929 <alltraps>
...
80106102:	6a 51                	push   $0x51
  jmp alltraps
80106104:	e9 20 f8 ff ff       	jmp    80105929 <alltraps>
...
8010610b:	6a 52                	push   $0x52
  jmp alltraps
8010610d:	e9 17 f8 ff ff       	jmp    80105929 <alltraps>
...
80106114:	6a 53                	push   $0x53
  jmp alltraps
80106116:	e9 0e f8 ff ff       	jmp    80105929 <alltraps>
...
8010611d:	6a 54                	push   $0x54
  jmp alltraps
8010611f:	e9 05 f8 ff ff       	jmp    80105929 <alltraps>
...
80106126:	6a 55                	push   $0x55
  jmp alltraps
80106128:	e9 fc f7 ff ff       	jmp    80105929 <alltraps>
...
8010612f:	6a 56                	push   $0x56
  jmp alltraps
80106131:	e9 f3 f7 ff ff       	jmp    80105929 <alltraps>
...
80106138:	6a 57                	push   $0x57
  jmp alltraps
8010613a:	e9 ea f7 ff ff       	jmp    80105929 <alltraps>
...
80106141:	6a 58                	push   $0x58
  jmp alltraps
80106143:	e9 e1 f7 ff ff       	jmp    80105929 <alltraps>
...
8010614a:	6a 59                	push   $0x59
  jmp alltraps
8010614c:	e9 d8 f7 ff ff       	jmp    80105929 <alltraps>
...
80106153:	6a 5a                	push   $0x5a
  jmp alltraps
80106155:	e9 cf f7 ff ff       	jmp    80105929 <alltraps>
...
8010615c:	6a 5b                	push   $0x5b
  jmp alltraps
8010615e:	e9 c6 f7 ff ff       	jmp    80105929 <alltraps>
...
80106165:	6a 5c                	push   $0x5c
  jmp alltraps
80106167:	e9 bd f7 ff ff       	jmp    80105929 <alltraps>
...
8010616e:	6a 5d                	push   $0x5d
  jmp alltraps
80106170:	e9 b4 f7 ff ff       	jmp    80105929 <alltraps>
...
80106177:	6a 5e                	push   $0x5e
  jmp alltraps
80106179:	e9 ab f7 ff ff       	jmp    80105929 <alltraps>
...
80106180:	6a 5f                	push   $0x5f
  jmp alltraps
80106182:	e9 a2 f7 ff ff       	jmp    80105929 <alltraps>
...
80106189:	6a 60                	push   $0x60
  jmp alltraps
8010618b:	e9 99 f7 ff ff       	jmp    80105929 <alltraps>
...
80106192:	6a 61                	push   $0x61
  jmp alltraps
80106194:	e9 90 f7 ff ff       	jmp    80105929 <alltraps>
...
8010619b:	6a 62                	push   $0x62
  jmp alltraps
8010619d:	e9 87 f7 ff ff       	jmp    80105929 <alltraps>
...
801061a4:	6a 63                	push   $0x63
  jmp alltraps
801061a6:	e9 7e f7 ff ff       	jmp    80105929 <alltraps>
...
801061ad:	6a 64                	push   $0x64
  jmp alltraps
801061af:	e9 75 f7 ff ff       	jmp    80105929 <alltraps>
...
801061b6:	6a 65                	push   $0x65
  jmp alltraps
801061b8:	e9 6c f7 ff ff       	jmp    80105929 <alltraps>
...
801061bf:	6a 66                	push   $0x66
  jmp alltraps
801061c1:	e9 63 f7 ff ff       	jmp    80105929 <alltraps>
...
801061c8:	6a 67                	push   $0x67
  jmp alltraps
801061ca:	e9 5a f7 ff ff       	jmp    80105929 <alltraps>
...
801061d1:	6a 68                	push   $0x68
  jmp alltraps
801061d3:	e9 51 f7 ff ff       	jmp    80105929 <alltraps>
...
801061da:	6a 69                	push   $0x69
  jmp alltraps
801061dc:	e9 48 f7 ff ff       	jmp    80105929 <alltraps>
...
801061e3:	6a 6a                	push   $0x6a
  jmp alltraps
801061e5:	e9 3f f7 ff ff       	jmp    80105929 <alltraps>
...
801061ec:	6a 6b                	push   $0x6b
  jmp alltraps
801061ee:	e9 36 f7 ff ff       	jmp    80105929 <alltraps>
...
801061f5:	6a 6c                	push   $0x6c
  jmp alltraps
801061f7:	e9 2d f7 ff ff       	jmp    80105929 <alltraps>
...
801061fe:	6a 6d                	push   $0x6d
  jmp alltraps
80106200:	e9 24 f7 ff ff       	jmp    80105929 <alltraps>
...
80106207:	6a 6e                	push   $0x6e
  jmp alltraps
80106209:	e9 1b f7 ff ff       	jmp    80105929 <alltraps>
...
80106210:	6a 6f                	push   $0x6f
  jmp alltraps
80106212:	e9 12 f7 ff ff       	jmp    80105929 <alltraps>
...
80106219:	6a 70                	push   $0x70
  jmp alltraps
8010621b:	e9 09 f7 ff ff       	jmp    80105929 <alltraps>
...
80106222:	6a 71                	push   $0x71
  jmp alltraps
80106224:	e9 00 f7 ff ff       	jmp    80105929 <alltraps>
...
8010622b:	6a 72                	push   $0x72
  jmp alltraps
8010622d:	e9 f7 f6 ff ff       	jmp    80105929 <alltraps>
...
80106234:	6a 73                	push   $0x73
  jmp alltraps
80106236:	e9 ee f6 ff ff       	jmp    80105929 <alltraps>
...
8010623d:	6a 74                	push   $0x74
  jmp alltraps
8010623f:	e9 e5 f6 ff ff       	jmp    80105929 <alltraps>
...
80106246:	6a 75                	push   $0x75
  jmp alltraps
80106248:	e9 dc f6 ff ff       	jmp    80105929 <alltraps>
...
8010624f:	6a 76                	push   $0x76
  jmp alltraps
80106251:	e9 d3 f6 ff ff       	jmp    80105929 <alltraps>
...
80106258:	6a 77                	push   $0x77
  jmp alltraps
8010625a:	e9 ca f6 ff ff       	jmp    80105929 <alltraps>
...
80106261:	6a 78                	push   $0x78
  jmp alltraps
80106263:	e9 c1 f6 ff ff       	jmp    80105929 <alltraps>
...
8010626a:	6a 79                	push   $0x79
  jmp alltraps
8010626c:	e9 b8 f6 ff ff       	jmp    80105929 <alltraps>
...
80106273:	6a 7a                	push   $0x7a
  jmp alltraps
80106275:	e9 af f6 ff ff       	jmp    80105929 <alltraps>
...
80106285:	6a 7c                	push   $0x7c
  jmp alltraps
80106287:	e9 9d f6 ff ff       	jmp    80105929 <alltraps>
...
8010628e:	6a 7d                	push   $0x7d
  jmp alltraps
80106290:	e9 94 f6 ff ff       	jmp    80105929 <alltraps>
...
80106297:	6a 7e                	push   $0x7e
  jmp alltraps
80106299:	e9 8b f6 ff ff       	jmp    80105929 <alltraps>
...
80106879:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010687e:	e9 a6 f0 ff ff       	jmp    80105929 <alltraps>
...
80106885:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010688a:	e9 9a f0 ff ff       	jmp    80105929 <alltraps>
...
80106891:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106896:	e9 8e f0 ff ff       	jmp    80105929 <alltraps>
...
8010689d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801068a2:	e9 82 f0 ff ff       	jmp    80105929 <alltraps>
...
8010690a:	e8 51 dd ff ff       	call   80104660 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a63:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a66:	e8 65 cd ff ff       	call   801037d0 <cpuid>
...
80106af0:	a1 a4 56 11 80       	mov    0x801156a4,%eax
{
...
80106b34:	0f 84 c2 00 00 00    	je     80106bfc <switchuvm+0xec>
  pushcli();
80106b3a:	e8 41 d9 ff ff       	call   80104480 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b3f:	e8 0c cc ff ff       	call   80103750 <mycpu>
80106b44:	89 c6                	mov    %eax,%esi
80106b46:	e8 05 cc ff ff       	call   80103750 <mycpu>
80106b4b:	89 c7                	mov    %eax,%edi
80106b4d:	e8 fe cb ff ff       	call   80103750 <mycpu>
80106b52:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b55:	83 c7 08             	add    $0x8,%edi
80106b58:	e8 f3 cb ff ff       	call   80103750 <mycpu>
...
80106be9:	5d                   	pop    %ebp
  popcli();
80106bea:	e9 d1 d8 ff ff       	jmp    801044c0 <popcli>
...
80106c4f:	e8 0c da ff ff       	call   80104660 <memset>
...
80106c80:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c81:	e9 8a da ff ff       	jmp    80104710 <memmove>
...
8010717f:	e8 8c d5 ff ff       	call   80104710 <memmove>
    len -= n;
    buf += n;

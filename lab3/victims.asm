...
_victims: formato do arquivo elf32-i386
...
{   
  ...
  18:	e8 25 03 00 00       	call   342 <getpid>
  printf(1, "PID Godfather %d", pidgodfather);
  ...
  30:	eb 0b                	jmp    3d <main+0x3d>
  32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  while (pid != 0 && victims < 100) {
  38:	83 fb 63             	cmp    $0x63,%ebx
  3b:	7f 1b                	jg     58 <main+0x58>
    pid = fork();
  3d:	e8 78 02 00 00       	call   2ba <fork>
    sleep(10);
  ...
  47:	83 c3 01             	add    $0x1,%ebx
    sleep(10);
  4a:	6a 0a                	push   $0xa
  4c:	e8 01 03 00 00       	call   352 <sleep>
  while (pid != 0 && victims < 100) {
  ...
  5b:	68 60 ea 00 00       	push   $0xea60
  60:	e8 ed 02 00 00       	call   352 <sleep>
  return exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb 99 07 00 00       	mov    $0x799,%ebx
        while(*s != 0){
